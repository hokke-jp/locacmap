...
shikoku.microposts.create!(title: '弘法大師が悟りを開いた場所。御厨人窟(みくろど)', content: '真言宗の開祖であり「弘法大師（こうぼうだいし）」として知られる空海の修行地。この場所からは空と海しか見えないため空海と名乗ったと言われています。', period_id: 10, prefecture_id: 39, latlng: "(33.25229209144667, 134.18097052003787)", created_at: 4.day.ago)
...
tyubu.microposts.create!(title: '川中島の今の姿', content: '戦国時代の最強武将と名高い武田信玄と上杉謙信。川中島はそんな二人が奪い合い、火花を散らした土地です。写真は最激戦だった第四次川中島の戦いの戦場だった八幡原(はちまんぱら)の今の姿です。', period_id: 7, prefecture_id: 20, latlng: "(35.33710732807216, 132.87221059002144)", created_at: 2.week.ago)
