...
# マイクロポスト
admin.microposts.create!(title: '葛飾北斎「神奈川沖浪裏」に似た構図が見られる地、千葉県銚子市', content: '海外でも人気な葛飾北斎の通称「波」。実際に描かれた場所については神奈川沖の船上と考えられています。写真は『産経新聞社「美しい日本を撮ろう」フォトコンテスト』で滑方清さんが撮影された一枚です。', period_id: 6, prefecture_id: 12, latlng: "(35.78257336213532, 140.82770410416438)")

kyusyu.microposts.create!(title: '天孫降臨。日本の歴史が始まった土地。', content: '天照大神の孫に当たる瓊瓊杵尊(ニニギノミコト)が降り立った土地です。瓊瓊杵尊は初代天皇・神武天皇の曾祖父に当たる方です。写真は宮崎県高千穂町にある「天孫降臨の滝」です。', period_id: 14, prefecture_id: 45, latlng: "(32.740212975906154, 131.30097750103604)")

shikoku.microposts.create!(title: '弘法大師が悟りを開いた場所。御厨人窟(みくろど)', content: '真言宗の開祖であり「弘法大師（こうぼうだいし）」として知られる空海の修行地。この場所からは空と海しか見えないため空海と名乗ったと言われています。', period_id: 10, prefecture_id: 39, latlng: "(33.25229209144667, 134.18097052003787)")
...
kanto.microposts.create!(title: '北条政子の墓、鎌倉・寿福寺', content: '北条政子と言えば尼将軍として鎌倉幕府を支えた女性で、「最後の詞」演説では女性でこんな演説ができる人物がいたのかと驚いたことを覚えています。彼女は後世「日本三大悪女」の一人に数えられますが、悪女と言えば私利私欲で動く人物に聞こえますが、私はそういう人物ではなかったと勝手に想像しています。', period_id: 9, prefecture_id: 14, latlng: "(35.32464311408548, 139.54775182181524)")

tohoku.microposts.create!(title: '後藤新平旧宅', content: '後藤新平といえば、当時戊辰戦争の直後でまだまだ東北出身者が活躍しにくかった頃、己の力だけで出世し、初代満鉄総裁や内務大臣として関東大震災の復興に当たった人物です。「金を残して死ぬ者は下だ。仕事を残して死ぬ者は中だ。人を残して死ぬ者は上だ。」', period_id: 5, prefecture_id: 3, latlng: "(39.14421784534702, 141.1383988379313)")
