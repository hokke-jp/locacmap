...
kanto.microposts.create!(title: '北条政子の墓、鎌倉・寿福寺', content: '北条政子と言えば尼将軍として鎌倉幕府を支えた女性で、「最後の詞」演説が有名だと思います。彼女は後世「日本三大悪女」の一人に数えられます。しかし、悪女と言えば私利私欲で動く人物に聞こえますが、私はそういう人物ではなく、自分の一族や鎌倉幕府のために人生を捧げた人だったと勝手に想像しています。', period_id: 9, prefecture_id: 14, latlng: "(35.32464311408548, 139.54775182181524)", created_at: 1.month.ago)
